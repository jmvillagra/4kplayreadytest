...
namespace SDKTemplate.Helpers
{
    ...
    {
        //private string licenseURL = "http://test.playready.microsoft.com/service/rightsmanager.asmx?(cfg=sl:3000)";
        //private string licenseURL = "http://test.playready.microsoft.com/service/rightsmanager.asmx";
        ...
        public String LicenseOverride { get; set; }

        public PlayReadyHelper()
        {            
        ...
        public void SetUpProtectionManager(MediaPlayer mediaPlayer)
        {
            ...
            protectionManager.Properties.Remove("Windows.Media.Protection.UseSoftwareProtectionLayer");
            protectionManager.Properties["Windows.Media.Protection.UseHardwareProtectionLayer"] = true;
        ...
        private async void ProtectionManager_ServiceRequested(MediaProtectionManager sender, ServiceRequestedEventArgs e)
        {
            ...
            else if (e.Request is PlayReadyLicenseAcquisitionServiceRequest)
            {
                ...
                if (!String.IsNullOrWhiteSpace(LicenseOverride))
                {
                    licenseRequest.Uri = new Uri(LicenseOverride);                    
                }
